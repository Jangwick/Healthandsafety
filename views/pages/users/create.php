    ...
    <div class="premium-card">
        ...
        <div class="card-banner">
            <div class="header-content">
                ...
                <div>
                    <h2 style="font-weight: 800; font-size: 1.5rem; margin: 0; letter-spacing: -0.5px;">Onboard New Personnel</h2>
                    <p style="margin: 0.25rem 0 0; opacity: 0.8; font-size: 0.9rem; font-weight: 500;">Provision a new system access account.</p>
                </div>
            </div>
            <div style="text-align: right;">
                <div style="font-size: 0.75rem; font-weight: 800; text-transform: uppercase; background: rgba(255,255,255,0.1); padding: 0.4rem 1rem; border-radius: 10px; border: 1px solid rgba(255,255,255,0.1);">Registration Portal</div>
            </div>
        </div>
        ...
        <form action="/users/store" method="POST">
            <div class="form-section">
                ...
                <div class="input-group-custom">
                    ...
                    <div class="field-wrapper">
                        ...
                        <input type="text" name="full_name" required placeholder="e.g. John Albert Doe" class="custom-input">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem; margin-bottom: 2rem;">
                    ...
                    <div class="input-group-custom" style="margin-bottom: 0;">
                        ...
                        <div class="field-wrapper">
                            ...
                            <input type="email" name="email" required placeholder="name@lgu.gov.ph" class="custom-input">
                        </div>
                    </div>
                    ...
                    <div class="input-group-custom" style="margin-bottom: 0;">
                        ...
                        <div class="field-wrapper">
                            ...
                            <select name="role_id" required class="custom-input role-select">
                                <option value="" disabled selected>Select Role Rank...</option>
                                <?php foreach ($roles as $role): ?>
                                    <option value="<?= $role['id'] ?>">
                                        <?= htmlspecialchars($role['name']) ?> (Hierarchy Lvl: <?= $role['hierarchy_level'] ?>)
                                    </option>
                                <?php endforeach; ?>
                            </select>
                ...
                <!-- Password -->
                <div class="input-group-custom" style="margin-bottom: 0;">
                    <label class="input-label">Initial Security Credential</label>
                    <div class="field-wrapper">
                        <i class="fas fa-lock field-icon"></i>
                        <input type="password" name="password" required placeholder="••••••••••••" class="custom-input">
                    </div>
                    <div class="password-hint">
                        <i class="fas fa-circle-info" style="font-size: 0.75rem; color: #f59e0b;"></i>
                        <span>Temporary password will be required for the first login sequence.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="action-bar">
                <a href="/users" class="btn-cancel">Exit Portal</a>
